...
namespace ClassLibrary.EntityData
{
    public class DB
    {
        ...
        public static 관할세무서Data 관할세무서 { get; } = new 관할세무서Data();
        ...
        public static 합계잔액시산표리스트Data 합계잔액시산표리스트 { get; } = new 합계잔액시산표리스트Data();
        public static 금융기관Data 금융기관 { get; } = new 금융기관Data();
    }
}
